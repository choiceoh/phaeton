...
const solarTemplates: MilestoneTemplate[] = [
  ...
  { name: '구조물 시공', category: 'construction', seqOrder: 10, typicalDays: 60, isCritical: false },
...
const windTemplates: MilestoneTemplate[] = [
  ...
  { name: '풍황계측 (1년+)', category: 'engineering', seqOrder: 2, typicalDays: 365, isCritical: true },
  ...
  { name: '기본설계 완료', category: 'engineering', seqOrder: 9, typicalDays: 60, isCritical: false },
  { name: '실시설계 완료', category: 'engineering', seqOrder: 10, typicalDays: 45, isCritical: false },
  ...
  { name: '기초·도로 공사', category: 'construction', seqOrder: 13, typicalDays: 120, isCritical: false },
  { name: '터빈 설치', category: 'construction', seqOrder: 14, typicalDays: 90, isCritical: true },
  { name: '전기·계통 공사', category: 'construction', seqOrder: 15, typicalDays: 60, isCritical: false },
...
const essTemplates: MilestoneTemplate[] = [
  ...
  { name: '배터리·PCS 발주', category: 'procurement', seqOrder: 5, typicalDays: 14, isCritical: true },
  { name: '착공신고', category: 'construction', seqOrder: 6, typicalDays: 7, isCritical: true },
  { name: '토목·건축 공사', category: 'construction', seqOrder: 7, typicalDays: 60, isCritical: false },
  { name: '배터리·PCS 설치', category: 'construction', seqOrder: 8, typicalDays: 30, isCritical: false },
  { name: '전기·소방 공사', category: 'construction', seqOrder: 9, typicalDays: 30, isCritical: false },
