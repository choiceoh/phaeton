  ...
  },
  {
    ...
    collection: {
      ...
      fields: [
        ...
        { slug: 'quantity', label: '수량', field_type: 'number', options: { decimal_places: 0 }, is_required: true, width: 2 },
  ...
  },
  {
    ...
    collection: {
      ...
      fields: [
        ...
        { slug: 'probability', label: '성공률', field_type: 'number', width: 2, options: { display_type: 'progress', decimal_places: 0 } },
  ...
  },
  {
    ...
    collection: {
      ...
      fields: [
        ...
        { slug: 'execution_rate', label: '집행률', field_type: 'number', width: 2, options: { display_type: 'progress', decimal_places: 0 } },
