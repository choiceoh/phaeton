...
export function ProjectGrid({ projects }: { projects: ProjectProgress[] }) {
  ...
  return (
    <div>
      <div className="mb-4 flex items-center gap-3">
        ...
        <Select value={deptFilter} onValueChange={setDeptFilter} className="max-w-[10rem]">
      ...
      {filtered.length === 0 && (
        <p className="py-8 text-center text-gray-500">조건에 맞는 프로젝트가 없습니다.</p>
      )}
    </div>
  )
}
