...
import { MILESTONE_STATUS_LABELS, MILESTONE_STATUS_COLORS, CATEGORY_LABELS } from '@/lib/constants'
  ...
  return (
    <div>
      {milestones.map((m, i) => {
        ...
        const category = m.template && typeof m.template === 'object' ? m.template.category : null
        const assigneeName = m.assignee && typeof m.assignee === 'object' ? m.assignee.name : null
          ...
          <div key={m.id} className="flex">
            ...
            <div className="pb-5">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Badge color={MILESTONE_STATUS_COLORS[m.status] || 'gray'}>
