...
export const WIDGET_REGISTRY: Record<string, WidgetDef> = {
  ...
  'expiring-calendar': {
    id: 'expiring-calendar',
    label: '서류 만료 캘린더',
    description: '90일 이내 만료 예정 서류 타임라인',
    category: 'alert',
    defaultW: 8,
    defaultH: 4,
    minW: 4,
